package com.example.movieapp.views.home.homePages.discoveryTab;
...
public class DiscoverPage extends Fragment {
    ...
    public static DiscoverPage newInstance() {
    ...
    public void ObserveAnyChange(){
        if(movieListViewModel!=null){
            movieListViewModel.getDiscoverMovies().observe(this, movieListResponse -> {
                if(movieListResponse == null) return;
                List<MovieModel> movieModels = movieListResponse.getMovies();
                    if(movieModels!=null){
    ...
    public void displayFilterSelection(){
        movieListViewModel.requestDiscoverMovies( gerne_id_string, selected_country, selected_year, 1);
    }
    public void initDisplayItem(int pos){
        ...
        discover_item.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent movie_info_intent= new Intent(getContext(), MovieInformation.class);
    ...
    public void displayNonFilter(){
        movieListViewModel.requestDiscoverMovies(" ", " ", 2024, 1);
    }

    public void displayNextNonFilter(){
        movieListViewModel.discoverMoviesNext();
    }
}