...
public class Credentials {
    ...
    public static final String functionname_history = "history";
    ...
    public static final String functionname_updateUser = "updateUser";
    public static final String functionname_forgotPassword = "forgetPassword";
