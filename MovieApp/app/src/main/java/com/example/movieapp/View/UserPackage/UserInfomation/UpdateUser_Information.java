...
public class UpdateUser_Information extends AppCompatActivity implements Form_validate, Edittext_interface {
    ...
    public void initComponents(){
        ...
        switch (updateInfo){
            case "username":
                ...
                username_up.setText(loginAccount.getUsername());
                break;
            case "email":
    ...
    public void saveUserInfo(){
        switch (updateInfo){
            case "username":
               this.loginAccount.setUsername(username_up.getText().toString().trim());
               break;
            case "email":
                this.loginAccount.setEmail(email_up.getText().toString().trim());
                break;
            case "password":
               this.loginAccount.setPassword(password_up.getText().toString().trim());
                break;
            case "sms":
                this.loginAccount.setSms(sms_up.getText().toString().trim());
                break;
        }
